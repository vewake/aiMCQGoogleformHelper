      ...
      {isLoaded && (
        <div>
          ...
          <div className='text-2xl text-center'>
            Made by <a href="https://github.com/vewake" className="text-blue-500">Vivek</a>
          </div>

          <div className='flex flex-row justify-center'>
            <a href=" https://github.com/vewake/aiGoogleFormSolverExtension" className="text-blue-500">
              Github
            </a>
          </div>
